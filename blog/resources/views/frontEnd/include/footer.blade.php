            ...
            <div class="col-md-12 col-lg-4">
                <div class="kavya-footer-intro">
                    <div class="footer-logo">
                        <a href="#">
                            <h5 class="brand-name">About Me</h5>
                        </a>
                    </div>
                    ...
                    <div class="posts-wrapper">
                        ...
                        <div class="card ">
                            <div class="row no-gutters">
                                <div class="col-3 col-md-3">
                                    <a href="single-layout-one.html">
                                        <img src="{{asset('frontEnd')}}/assets/images/orange-bus.jpg" class="card-img" alt="">
                                    </a>
                                </div>
                                <div class="col-9">
                                    <div class="card-body">
                        ...
                        <div class="card ">
                            <div class="row no-gutters">
                                <div class="col-3 col-md-3">
                                    <a href="single-layout-one.html">
                                        <img src="{{asset('frontEnd')}}/assets/images/girl.jpg" class="card-img" alt="">
                                    </a>
                                </div>
                                <div class="col-9">
                                    <div class="card-body">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-copyright">
                <p> &copy;2023 All rights reserved. <a href="#"></a> </p>
            </div>
        </div>
    </div>
</footer>
