        ...
        <div class="container">
            <div class="banner-carousel">
                <div class="banner-item">
                    <div class="card">
                        <a href="single-layout-one.html"><img src="{{asset('frontEnd')}}/assets/images/baby-girl.jpg" class="card-img" alt="" /></a>
                ...
                <div class="banner-item">
                    <div class="card">
                        <a href="single-layout-one.html"><img src="{{asset('frontEnd')}}/assets/images/london.jpg" class="card-img" alt="" /></a>
                        <div class="card-img-overlay banner-text">
                            <ul class="category-tag-list">
                                <li class="category-tag-name">
                                    <a href="#">travel</a>
                ...
                <div class="banner-item">
                    <div class="card">
                        <a href="single-layout-one.html"><img src="{{asset('frontEnd')}}/assets/images/blonde-girl.jpg" class="card-img" alt="" /></a>
                        <div class="card-img-overlay banner-text">
                            <ul class="category-tag-list">
                                <li class="category-tag-name">
                                    <a href="#">Lifestyle</a>
